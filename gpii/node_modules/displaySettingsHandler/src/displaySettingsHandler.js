...
fluid.defaults("gpii.windowsDisplay", {
    ...
    invokers: {
        ...
        get: {
            funcName: "gpii.windows.displaySettingsHandler.get",
            args: ["{arguments}.0"]
                   // payload
        },
        set: {
            funcName: "gpii.windows.displaySettingsHandler.set",
            args: ["{arguments}.0"]
                   // array of settings
        }
    }
...
/*
 * Returns the display's current screen resolution.
 *
...
gpii.windows.display.getImpl = function () {
    ...
    fluid.set(screenResolution, "screen-resolution", gpii.windows.display.getScreenResolution());
