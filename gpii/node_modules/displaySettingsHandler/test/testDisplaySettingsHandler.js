...
jqUnit.test("Testing setScreenBrightness ", function () {
    if (gpii.windows.display.isBrightnessSupported()) {
        // Get old brightness
        var oldBrightness = gpii.windows.display.getScreenBrightness();
        ...
        levels.forEach(function (newBrightness) {
            ...
            gpii.windows.display.setScreenBrightness(newBrightness);
            var curBrightness = gpii.windows.display.getScreenBrightness();
        ...
        gpii.windows.display.setScreenBrightness(oldBrightness);
    } else {
...
jqUnit.test("Testing displaySettingsHandler setScreenBrightnessWithPayload", function() {
    if (gpii.windows.display.isBrightnessSupported()) {
        ...
        var oldPayload = gpii.windows.display.getImpl();
        ...
        gpii.windows.display.setImpl(payload);
        ...
        gpii.windows.display.setScreenBrightness(oldPayloadVal);
    } else {
