...
// NB this is not a useful unit test as depends on screen settings - but useful for TDD
jqUnit.test("Testing Get screen res", function () {
	jqUnit.expect(1);

	var checkScreenRes = function () {
	var width = 1920;
	var height = 1080;

	var res = gpii.windows.getScreenResolution();
	...
	jqUnit.assertDeepEq("expect screen res.", true, checkScreenRes());
});
