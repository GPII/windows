...
var settingName = "screen-resolution";

windows.display.setImpl = function (payload) {
    var oldRes = windows.display.getScreenResolution();
    var newRes = oldRes;

    var targetRes = payload.settings[settingName];
    if (undefined === targetRes ||
        undefined === targetRes.width ||
        undefined === targetRes.height) {
    ...
    var results = {};
    results[settingName] = { oldValue: oldRes, newValue: newRes };
...
windows.display.getImpl = function () {
    ...
    var results = {};
    results[settingName] = curRes;

    fluid.log("display settings handler GET returning results ", results);
    return results;
};
