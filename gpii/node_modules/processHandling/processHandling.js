 ...
 *
 * @param {string|number} process The name of the executable, or the process ID.
 * @return {boolean} true if the process is running.
 */
gpii.windows.isProcessRunning = function (process) {
    var togo = false;
    if (isNaN(process)) {
        togo = gpii.windows.findProcessByName(process) !== null;
    } else {
        try {
