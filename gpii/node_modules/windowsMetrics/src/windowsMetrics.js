...
/** The collection of known running applications. */
...
/**
 * Monitor the active window, recording the time it's been active for. Also used to record application launches.
 *
 * @param currentPid {Number} [Optional] Used internally: The pid of the currently active window.
 */
gpii.windows.activeWindowTime = function (currentPid) {
    var activePid = 0;
    var lastHwnd = 0;
    ...
    windows.waitForCondition(function () {
        ...
        gpii.windows.activeWindowTime(activePid);
    });
};
