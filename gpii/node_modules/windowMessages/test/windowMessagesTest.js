...
jqUnit.asyncTest("Window Messages - Message sending", function () {
    ...
    var WM_USER = 0x400;
    var WM_GPII_TEST = gpii.windows.user32.RegisterWindowMessageW(gpii.windows.stringToWideChar("GPII_TEST_MESSAGE"));;
    ...
    instance.events.onMessage.addListener(function (hwnd, msg, wParam, lParam) {
        if (currentTest && msg === currentTest.msg) {
    ...
    var nextTest = function () {
        ...
        if (currentTestIndex >= tests.length) {
            ...
            gpii.windows.messages.sendMessage(window, currentTest.msg, currentTest.wParam, currentTest.lParam);
        }
    };
