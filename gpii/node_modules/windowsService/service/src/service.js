...
if (service.config.logging && logging.levels[service.config.logging.level]) {
    logging.logLevel = logging.levels[service.config.logging.level];
}
...
service.start = function () {
    ...
    if (!service.isService || windows.isUserLoggedOn()) {
        // Service started when already logged on.
        service.event("svc-sessionchange", "session-logon");
    }
