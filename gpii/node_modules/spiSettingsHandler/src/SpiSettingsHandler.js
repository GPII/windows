...
var systemParametersInfoWUint = ffi.Library("user32", {
    "SystemParametersInfoW": [
...
spi.applySettings = function (payload) {
    ...
    if (pvParamType === "BOOL" || pvParamType === "UINT") {
        callSuccessful = systemParametersInfoWUint.SystemParametersInfoW(action, uiParam, pvParam, 0);
    } else {
...
gpii.windows.spiSettingsHandler.updateCursors = function () {
    ...
    systemParametersInfoWUint.SystemParametersInfoW(0x57, 0, 0, 0);
};
