 ...
 *
 * @param settings {object} The JSON to pass to the application. An array of objects containing settingID, method, and
 * parameters.
 ...
 *
 * @param get {boolean} true to 'get', otherwise 'set'.
