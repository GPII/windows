 ...
 * @property {String} requestName The name of the request to perform.
 * @property {Mixed} [various] Zero or more additional fields specific to the request.
 */

// Handles requests from the service.
// handleRequest() is invoked when a ServiceRequest is received from the service. The requestName field of the
 ...
 * @param {ServiceRequest} request The request. It should at least contain "action" which is the name of the request.
 */
gpii.windows.service.handleRequest = function (that, request) {
    fluid.log("Service: request", request);
    var handler = that[request.requestName];
