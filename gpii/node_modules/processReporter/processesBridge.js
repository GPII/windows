 ...
 * process name is passed, then the return value will be limited to only
 * only processes with that name.
 *
 * @param {String} Optional.  The process name
 */
// Return a list of processes -- a snapshot of the current processes.
gpii.processes["native"].getProcessList = function (processName) {
    return dotNetProcesses(processName, true);
};
