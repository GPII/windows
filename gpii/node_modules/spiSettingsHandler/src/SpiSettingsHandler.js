...
// GetSystemMetrics
// https://msdn.microsoft.com/en-us/library/windows/desktop/ms724385
// This function is going to be used for getting the current set setting for
// SPI_SETMOUSEBUTTONSWAP, due that the systemParametersInfoWPtr only provides
// a set mechanism.
gpii.windows.spi.getSystemMetricsPtr = ffi.Library("user32", {
    "GetSystemMetrics": [
        "int32", ["int32"]
    ]
});

var SystemMetricsConstants = {
    SM_SWAPBUTTON: 23
};
...
gpii.windows.spi.getCurrentSettings = function (payload) {
    ...
    if (getAction ===  gpii.windows.actionConstants.SPI_GETMOUSEBUTTONSWAP) {
        var swapped = gpii.windows.spi.getSystemMetricsPtr.GetSystemMetrics(SystemMetricsConstants.SM_SWAPBUTTON);
...
>>>>>>> 91174ac7200f48a05b0f050845e04bbe2e955e3b
