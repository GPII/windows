...
gpii.windows.iod.appx.install = function (that, installation, install) {
    ...
    var promise = installation.packageData.elevate
        ? that.invokeElevated("powershell", args)
        : that.startProcess("powershell", args);

    promise.then(function () {
        // A hack to make the language list update.
        gpii.windows.messages.sendMessage("gpii-message-window", gpii.windows.API_constants.WM_INPUTLANGCHANGE, 0, 0);
    });
