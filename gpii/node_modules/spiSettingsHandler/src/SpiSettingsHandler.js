...
// windows.callSPI = function(payload) {
	...
	// if (payload.pvParam.type === "struct") {
		// pvParam = windows.createEmptyStructure(payload.pvParam.name);
	...
	// //console.log("Name: " + pvParam.lpszDefaultScheme.getCString());
	// for (var member in pvParam) {
		// console.log("pvParam member is: " + member);
	// }
	// var flag = windows.getFlagValue(action, uiParam, "HIGHCONTRAST", "HCF_HOTKEYACTIVE");
	// console.log(flag);
	// return returnCode;
// };
...
windows.spiSettingsHandler = function(payload) {
	...
	// TODO Check what the value is in the payload before setting it ?
