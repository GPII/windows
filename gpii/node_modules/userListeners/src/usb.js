...
fluid.defaults("gpii.userListeners.usb.windows", {
    ...
    invokers: {
        startListener: "{that}.messages.start",
        stopListener: "{that}.messages.stop"
    },
    components: {
        messages: {
            type: "gpii.windows.messages"
        }
    },
    listeners: {
        "{messages}.events.onMessage": {
            funcName: "gpii.windows.userListeners.windowMessage",
 ...
 */
gpii.windows.userListeners.windowMessage = function (that, hwnd, msg, wParam, lParam) {
