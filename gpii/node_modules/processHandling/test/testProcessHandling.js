...
jqUnit.asyncTest("Testing restartExplorer", function () {
    ...
    var exePath = path.join(__dirname, "test-window.exe");
    jqUnit.assertFalse("There shouldn't be a test-window process running.", gpii.windows.isProcessRunning(exePath));

    teardowns.push(function () {
        gpii.windows.killProcessByName("test-window.exe");
    });
    ...
    fluid.promise.sequence([
        restartPromise,
        gpii.windows.waitForProcessStart(exePath)
    ]).then(function () {
