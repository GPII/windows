...
/**
 * Kills any windows processes with a given application filename using pskill.
 *
...
gpii.windows.killProcessByName = function (filename) {
    ...
    exec("pskill " + filename, function (e, stdout) {
        if (e) {
            togo.reject({isError: true, message: stdout});
        } else {
            togo.resolve(stdout);
        }
    });
