...
var ref = require("ref");
var dotnet_functions = require(__dirname + "/../WindowsUtilities/EdgeBindings");
...
gpii.windows.killProcessByName = function (filename) {
    dotnet_functions.kill_process({"processName": filename}, true);
};
...
gpii.windows.waitForProcessState = function (filename, options) {
    ...
    var checkProcess = function () {
        ...
        fluid.log("Checking for process " + filename + " - running: " + running);
