...
fluid.defaults("gpii.processes.windows", {
    ...
    invokers: {
        ...
        compareProcessNames: {
            funcName: "gpii.processes.windows.compareProcessNames",
...
/**
 * Compares the names of two processes, returning a boolean indicating whether or not they are equal, ignoring case.
 *
 * @param processA {String} Name of a process.
 * @param processB {String} Name of another process.
 */
gpii.processes.windows.compareProcessNames = function (processA, processB) {
    return processA.toLowerCase() === processB.toLowerCase();
};
