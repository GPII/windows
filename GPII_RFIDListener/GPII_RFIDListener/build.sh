...
mkdir -p build
g++ -I./libcurl -c $COPTS -DCURL_STATICLIB -o build/GPII_RFIDListener.o GPII_RFIDListener.cpp
...
g++ -static-libgcc -static-libstdc++ -o build/GPII_RFIDListener.exe build/WinSmartCard.o build/GPII_RFIDListener.o -L./build -L./libcurl -lWinSCard -lcurl -lwsock32 -lWs2_32
