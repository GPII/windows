...
jqUnit.asyncTest("Testing application metrics", function () {
    ...
    windowsMetrics.model.config.application.precision = 1;
...
gpii.tests.metrics.recordKeyTimingTests = function (theTests) {
    ...
    fluid.each(testData, function (test) {
        ...
        windowsMetrics.model.state.input = state;
        windowsMetrics.model.config.input = state.config;
...
jqUnit.asyncTest("Testing input metrics: inputHook", function () {
    ...
    windowsMetrics.model.config.input.minSession = windowsMetrics.model.config.input.sessionTimeout = -1 >>> 0;
    windowsMetrics.model.config.input.maxRecords = 1;
...
jqUnit.asyncTest("Testing input metrics: inactivity", function () {
    ...
    windowsMetrics.model.config.input.inactiveTime = 1;
    windowsMetrics.startInputMetrics();
    var state = windowsMetrics.model.state.input;
