...
jqUnit.test("Testing 'set' request building for systemSettingsHandler", function () {
    ...
    var autoRequest = windows.accentColor.buildSystemSettingsRequest("set", autoPayload);
    ...
    var numberRequest = windows.accentColor.buildSystemSettingsRequest("set", autoPayload);
...
jqUnit.test("Testing 'get' request building for systemSettingsHandler", function () {
    ...
    var request = windows.accentColor.buildSystemSettingsRequest("get", payload);
...
jqUnit.test("Testing translation of results from systemSettingsHandler", function () {
    ...
    var results = windows.accentColor.mapSysResults("set", sysResults);
...
jqUnit.asyncTest("Testing the getter accentColorSettingsHandler", function () {
    ...
    var pRes = windows.accentColor.getImpl(payload);
    pRes.then(
        function (results) {
            var expResults = {
                color: {},
...
jqUnit.asyncTest("Testing the setter/getter accentColorSettingsHandler", function () {
    ...
    var pCurSet = windows.accentColor.getImpl(payload);
    ...
    pCurSet.then(
        function (actualSettings) {
            ...
            var pRes = windows.accentColor.setImpl(newSettingsPayload);
            pRes.then(
                function (results) {
                    var expResults = {
                        transparencyEffects: {
                    ...
                    var pRecovery = windows.accentColor.setImpl(curSettings);
                    pRecovery.then(
                        function () {
                            jqUnit.start();
                        },
