...
jqUnit.asyncTest("Checking systemSettignsHandler internal tests", function () {
    var settingsHelperTests =
        path.join(__dirname, "../../../../settingsHelper/x64/Release/SettingsHelperTests.exe");
    var xmlOutputArg =
        "--gtest_output=xml:gpii/node_modules/systemSettingsHandler/test/test_detail.xml";

    jqUnit.expect(1);

    child_process.execFile(settingsHelperTests, [xmlOutputArg], function () {
