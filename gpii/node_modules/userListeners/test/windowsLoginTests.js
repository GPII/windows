...
jqUnit.test("Testing getUserId", function () {
    ...
    var regResult = gpii.windows.userListeners.getUserId("reg:" + baseKey + "\\" + subKey + "\\" + valueName);
    jqUnit.assertEquals("getUserId(file) should return the correct value", userValue, regResult);

    // Abbreviated base key
    var regResult2 = gpii.windows.userListeners.getUserId("reg:" + "HKCU\\" + subKey + "\\" + valueName);
    jqUnit.assertEquals("getUserId(file) should return the correct value", userValue, regResult2);

    // Non existing registry key
    var regResult3 = gpii.windows.userListeners.getUserId("reg:" + "HKCU\\gpii\\does\\not\\exist");
