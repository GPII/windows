...
jqUnit.asyncTest("Testing waiting for processes death", function () {
    ...
    // Create the process, with a 30 second timeout
    shelljs.exec(waitExePath + " waitForProcessTerminationTest /T 30 > nul", {
        async: true
    });
    ...
    gpii.tests.waitForTask(checkForTask, function () {
        ...
        jqUnit.assertEquals("Child-process should have died.", false, checkForTask());
    }, 10);
});
