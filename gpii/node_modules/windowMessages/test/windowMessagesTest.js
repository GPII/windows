...
jqUnit.asyncTest("Window Messages - Window creation and destruction", function () {
    ...
    var windowExists = function () {
        return !!gpii.tests.windowMessages.findWindow(gpii.windows.messages.windowClassname);
    };

    var messages = gpii.windows.messages();
    ...
    var work = [
        ...
        function () {
            ...
            return gpii.windows.waitForCondition(windowExists, {
                timeout: 5000,
                error: "Message window should be destroyed (after destroy)",
                conditionValue: false
            });
        }
    ];
...
jqUnit.test("Window Messages - Message receipt", function () {
    ...
    var instance1 = gpii.windows.messages();
    var instance2 = gpii.windows.messages();
    ...
    instance2.events.onMessage.addListener(function (hwnd, msg, wParam, lParam) {
        if (msg === WM_USER) {
            ...
            jqUnit.fail("Should not have received message after being stopped");
        }
    });
