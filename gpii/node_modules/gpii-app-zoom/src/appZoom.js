...
windows.appZoom.setControlKeyState = function (down) {
    ...
    windows.user32.keybd_event(windows.API_constants.VK_CONTROL, 0, flags, 0);
    if (!down) {
        // ensure both keys are up
        windows.user32.keybd_event(windows.API_constants.VK_CONTROL, 0, flags | KEYEVENTF_EXTENDEDKEY, 0);
    }
};
...
windows.appZoom.getWindowInfo = function (hwnd) {
    ...
    if (pid) {
        var processPath = processesBridge.getProcessPath(pid);
