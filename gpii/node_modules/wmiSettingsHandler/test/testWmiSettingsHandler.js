...
jqUnit.test("Testing wmiSettingsHandler set handles null/non null oldValue", function () {
    ...
    var oldGetImpl = windows.wmi.getImpl;
    windows.wmi.getImpl = function (payload) {
    ...
    var result = windows.wmi.setImpl(payload);
    windows.wmi.getImpl = oldGetImpl;
    jqUnit.assertEquals("The handler should attempt to set value when setting is supported.", 20, result.Brightness.oldValue);
});
