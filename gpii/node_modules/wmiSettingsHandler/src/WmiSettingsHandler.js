...
/**
 * NOTE: This function is a temporal workaround added because of
 * GPII-3987, and will be removed once GPII-3958 is implemented.
 *
 * Gets the current system brightness value making the proper
 * query to the wmiSettingsHandler.
 *
 * @return {Number} The current system brightness, the value
 *  is withing the 0 to 100 decimal range. If the current system
 *  doesn't support setting the screen brightness NaN is returned.
 */
gpii.windows.wmi.getCurrentBrightness = function () {
    var payload = {
        "settings": {
            "Brightness": {}
        },
    ...
    var wmiResult = gpii.windows.wmi.getImpl(payload);
    var currentBrightness = wmiResult.Brightness.value;
