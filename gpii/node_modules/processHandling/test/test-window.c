...
int window() {
    // Create the window
	HWND wnd = CreateWindowEx(0, TEXT("STATIC"), TEXT("GPII-TEST-WINDOW"), 0*WS_OVERLAPPEDWINDOW, 0, 0, 0, 0, NULL, NULL, GetModuleHandle(NULL), NULL);
	MSG msg;
	BOOL ret;
...
#define TIMER_ID 2
	...
	puts("test-window: Window created");
