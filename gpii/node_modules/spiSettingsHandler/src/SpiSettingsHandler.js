...
windows.populateResults = function (payload, isNewValue, results) {
	...
	for (var currentSetting in payload.settings) {	
		...
		if (settingValue.dataType === "dwFlags") {
...
windows.spiSettingsHandler = function (payload) {
	// TODO Add support for settings that are not stored in structures.
	...
	// FIXME Filter flag values from non-flag values. Support setting non-flag values.
