...
The end of a sub-session is determined when the user keys out (`SessionEnd`), or when the system has not received any
input for a period of time (`inactive-begin`).
