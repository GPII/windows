...
windows.desktopBackground.addBackgroundType = function (request, _, mode) {
    if (mode === "get") {
...
windows.desktopBackground.addSolidColor = function (request, _, mode) {
    if (mode === "set") {
        request.settings[windows.desktopBackground.revIdMaps.BackgroundType] = {
...
windows.desktopBackground.addPicture = function (request, payload, mode) {
    if (mode === "set") {
        request.settings[windows.desktopBackground.revIdMaps.BackgroundType] = {
            value: "Picture"
        };
...
windows.desktopBackground.addSlideshow = function (request, payload, mode) {
    if (mode === "set") {
        request.settings[windows.desktopBackground.revIdMaps.BackgroundType] = {
            value: "Slideshow"
        };
...
windows.desktopBackground.setImpl = function (payload) {
    ...
    if (sysRequest[1] !== undefined) {
        ...
        var getWallPr = windows.desktopBackground.getDeskWallpaper();
