...
spi.populateResults = function (payload, isNewValue, isGetting, results) {
    ...
    for (var currentSetting in payload.settings) {
        ...
        var valueToSet = windows.resolvePath(systemSettings, payload.settings[currentSetting].path);
...
spi.getPvParam = function (payload) {
    ...
    for (var currentSetting in payload.settings) {
        windows.resolvePath(systemSettings, payload.settings[currentSetting].path, payload.settings[currentSetting].value);
    }
...
gpii.windows.spiSettingsHandler.set = function (payload) {
    return gpii.invokeSettingsHandler(payload, spi.setOne);
};
