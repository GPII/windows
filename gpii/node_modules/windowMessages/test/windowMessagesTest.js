...
jqUnit.test("Window Messages - Message sent", function () {
    ...
    // Send a message to the window
    var first_message = {msg: messages[0].msg, wparam: messages[0].wparam, lparam: messages[0].lparam};
    gpii.windows.sendWindowMessage(first_message);

    // Stop one instance from listening
    instance2.stop();

    // Send second message
    var second_message = {msg: messages[1].msg, wparam: messages[1].wparam, lparam: messages[1].lparam};
    gpii.windows.sendWindowMessage(second_message);
