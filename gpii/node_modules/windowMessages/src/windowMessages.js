...
fluid.defaults("gpii.windows.messages", {
    ...
    invokers: {
        ...
        sendMessage: {
            ...
            args: ["{arguments}.0", "{arguments}.0", "{arguments}.0", "{arguments}.0"]
        }
    },
    members: {
 ...
 * @return {Number} The result of the message.
 */
gpii.windows.messages.sendMessage = function (window, msg, wParam, lParam) {
    ...
    var sendMessage = (typeof(lParam) === "number")
        ? windows.user32.SendNotifyMessageA
