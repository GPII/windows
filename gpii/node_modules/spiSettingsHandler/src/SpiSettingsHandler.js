...
spi.getCurrentSettings = function (payload) {
    ...
    var callSuccessful = user32.SystemParametersInfoW(getAction, uiParam, pvParam, 0);
...
spi.applySettings = function (payload) {
    ...
    var callSuccessful = user32.SystemParametersInfoW(action, uiParam, pvParam, 0);
...
spi.getPvParam = function (payload) {
    ...
    if (payload.options.pvParam.type === "array") {
        ...
        //pvParam = ref.alloc(windows.types[payload.options.pvParam.type], systemSettings.pvParam);
...
gpii.windows.spiSettingsHandler.set = function (payload) {
    return gpii.settingsHandlers.invokeSettingsHandler(spi.setImpl, payload);
};
...
gpii.windows.spiSettingsHandler.get = function (payload) {
    return gpii.settingsHandlers.invokeSettingsHandler(spi.getImpl, payload);
};
...
gpii.windows.spiSettingsHandler.updateCursors = function () {
    ...
    user32.SystemParametersInfoW(0x57, 0, 0, 0);
};
