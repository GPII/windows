...
// Windows Server 2019 is based on Windows 10 1809, this is 10.0.17763
// Information on Windows versions: https://en.wikipedia.org/wiki/Windows_10_version_history
var isWindowsServer2019 = (os.release() === "10.0.17763")? true: false;
    ...
    // Perform the tests in a single chunk, to save starting so many processes.
    {
        ...
        expect: {
            ...
            "bg-GB": {
                ...
                "native": isWindowsServer2019? "": "български (bg-GB)",
                "code": "bg-GB"
            },
            "ta-LK": {
            ...
            "en-xyz": {
                ...
                "native": isWindowsServer2019? "": "English (en-xyz)",
                "code": "en-xyz"
            }
        }
    },
