...
jqUnit.test("Test getProcessCreationTime", function () {
    ...
    // This process
    var thisProcess = gpiiProcess.getProcessCreationTime(process.pid);
...
jqUnit.asyncTest("Test isProcessRunning", function () {
    ...
    pid = process.pid;
    creationTime = gpiiProcess.getProcessCreationTime(pid);
    running = gpiiProcess.isProcessRunning(pid);
    jqUnit.assertTrue("This process (with creation time) should be running", running);

    // This process, with wrong creation time
    pid = process.pid;
    creationTime = "12345";
    running = gpiiProcess.isProcessRunning(pid, creationTime);
    ...
    var testChild = function (openHandle) {
        ...
        var child = gpiiProcessTests.startProcess();
        running = gpiiProcess.isProcessRunning(child.pid);
