 ...
 * @param {Boolean} dryRun True to only return the display name, and not apply it [default: false].
 * @return {String} The display name of the theme specified in the .theme file.
 */
gpii.windows.setHighContrastTheme = function (filename, dryRun) {
    var themeData = gpii.iniFile.readFile(filename);
...
fluid.defaults("gpii.windows.setHighContrastTheme", {
    gradeNames: "fluid.function",
    argumentMap: {
        filename: 0
    }
