...
windows.user32 = ffi.Library("user32", {
    ...
    // https://msdn.microsoft.com/en-us/library/windows/desktop/dd144871.aspx
    "GetDC": [
        // HWND
        t.HANDLE, [ t.HANDLE ]
    ],
...
windows.gdi32 = ffi.Library("gdi32", {
    // https://msdn.microsoft.com/en-us/library/windows/desktop/dd144877.aspx
    // HDC, int
    "GetDeviceCaps": [
        t.HANDLE, [ t.HANDLE, "int" ]
    ]
});
