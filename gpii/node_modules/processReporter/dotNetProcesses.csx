...
public class Startup
{
    public async Task<object> Invoke(dynamic input)
    {
        ...
        for (int i = 0; i < processes.Length; i++) {
            ...
            // Get full path via the process's MainModule.
            try {
            ...
            // If full path wasn't retrieved via MainModule, take it from
            // argv[0], and/or insure that argv[0] is the full path.
            if (aProcInfo.argv.Length > 0) {
                if (aProcInfo.fullPath == "") {
