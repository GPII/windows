...
jqUnit.test(
    ...
    function () {
        ...
        if (!wasRunning) {
            launcher.exec("Magnify");
            // Give Magnfiy some time to start and initialize itself.
            procTests.waitMsec(5000);
        }
        // Magnify should be running by now.
        magnifyProcInfo = processesBridge.findFirstProcessByCommand("Magnify");
        ...
        windows.killProcessByName("Magnify");
        procTests.waitMsec(5000);
