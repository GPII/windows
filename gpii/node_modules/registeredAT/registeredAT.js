...
gpii.windows.enableRegisteredAT = function (name, enable, options) {
    ...
    if (enable && !options.configOnly) {
        ...
        gpii.windows.whilePendingAT().then(function () {
            ...
            gpii.windows.writeRegistryKey(accessibilityTempKey.baseKey, accessibilityTempKey.path, name, targetValue,
                "REG_DWORD");
...
gpii.windows.whilePendingAT = function (options) {
    ...
    var checkActions = function () {
        ...
        var found = false;
        gpii.windows.enumRegistryValues(accessibilityTempKey.baseKey, accessibilityTempKey.path,
            function (name, data) {
