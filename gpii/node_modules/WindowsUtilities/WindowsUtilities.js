 ...
 */
windows.setScreenResolution = function (newRes) {
    if (undefined === newRes ||
        null === newRes ||
    ...
    while (c.FALSE != windows.user32.EnumDisplaySettingsW(ref.NULL, index++, dm.ref())) {
        if (dm.dmPelsWidth == newRes.width && dm.dmPelsHeight == newRes.height) {
            ...
            if (c.FALSE != windows.user32.EnumDisplaySettingsW(ref.NULL, c.ENUM_CURRENT_SETTINGS, dmCurrent.ref())) {
                ...
                var lRet = windows.user32.ChangeDisplaySettingsW(dmCurrent.ref(), 0);
