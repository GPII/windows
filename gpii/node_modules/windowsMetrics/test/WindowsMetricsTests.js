    ...
    {   // Mouse wheel up multiple
        input: {
            ...
            lParam: {
                ptX: 1,
                ptY: 2,
                mouseData: gpii.windows.makeLong(0, 5),
                flags: 0,
                time: 0,
                dwExtraInfo: 0
            }
    ...
    {   // Mouse wheel down multiple
        input: {
            ...
            lParam: {
                ptX: 1,
                ptY: 2,
                mouseData: gpii.windows.makeLong(0, 3),
                flags: 0,
                time: 0,
                dwExtraInfo: 0
            }
...
gpii.tests.metrics.convertLParam = function (wParam, lParam) {
    var mouseInput =
        wParam === gpii.windows.API_constants.WM_MOUSEWHEEL ||
        wParam === gpii.windows.API_constants.WM_LBUTTONUP ||
        wParam === gpii.windows.API_constants.WM_RBUTTONUP;
    ...
    var lParamBuf;
    if (mouseInput) {
        lParamBuf = ref.alloc(gpii.windows.RAWINPUTKEYBOARD.size);
