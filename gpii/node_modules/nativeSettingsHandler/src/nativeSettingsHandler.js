 ...
 *
 * @return {Number} The current system double click time for mouse.
 */
 ...
 * @return {Object} Object with the error information.
 */
...
/**
 * Sets the current system solid color.
 *
 * @param {Object} color Object getting rgb colors.
 * @return {Promise} Resolves on success, fails on error.
 */
windows.nativeSettingsHandler.SetSolidColor = function (color) {
    var pRes = fluid.promise();

    var res = windows.setSolidColor(color);
...
/**
 * Gets the current system solid color.
 *
...
windows.nativeSettingsHandler.GetSolidColor = function () {
    ...
    pRes.resolve(windows.getSolidColor());
...
windows.nativeSettingsHandler.setImpl = function (payload) {
    ...
    var setFn = windows.nativeSettingsHandler.functions[payload.options.functionName].set;
    var getFn = windows.nativeSettingsHandler.functions[payload.options.functionName].get;
