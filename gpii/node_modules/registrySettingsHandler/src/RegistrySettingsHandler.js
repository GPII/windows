...
windows.registrySettingsHandler.get = function (payload) {
    return gpii.windows.invokeSettingsHandler(payload, windows.registrySettingsHandler.getImpl);
};

windows.registrySettingsHandler.set = function (payload) {
    return gpii.windows.invokeSettingsHandler(payload, windows.registrySettingsHandler.setImpl);
};
