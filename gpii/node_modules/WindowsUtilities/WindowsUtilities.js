...
windows.user32 = ffi.Library("user32", {
    ...
    // https://docs.microsoft.com/es-es/windows/win32/api/winuser/nf-winuser-getmessagetime
    "GetMessageTime": [
        t.LONG, []
    ]
});
...
windows.API_constants = {
    ...
    SW_SHOWMAXIMIZED: 3,
    SW_SHOWNOACTIVATE: 4,
    // https://docs.microsoft.com/es-es/windows/win32/api/winuser/ns-winuser-rawmouse
...
// https://docs.microsoft.com/es-es/windows/win32/api/winuser/ns-winuser-rawinputheader
...
// https://docs.microsoft.com/es-es/windows/win32/api/winuser/ns-winuser-rawkeyboard
...
// https://docs.microsoft.com/es-es/windows/win32/api/winuser/ns-winuser-rawhid
...
// https://docs.microsoft.com/es-es/windows/win32/api/winuser/ns-winuser-rawinput?redirectedfrom=MSDN
