...
gpii.windows.spi.systemParametersInfo = function (pvParamType, action, uiParam, pvParam, fWinIni = 0) {
...
gpii.windows.spi.getFWinIni = function (payload) {
    ...
    if (flagValue === undefined) {
        Console.log("SpiSettingsHandler.js: spi.getFWinIni() got unknown fWinIni param value: " + fWinIni + " of type " + typeof fWinIni + ".");
        return 0;
    } else {
        return flagValue;
    }
