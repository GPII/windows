...
gpii.windows.userListeners.listenForTags = function (options) {
    ...
    if (!gpii.windows.userListeners.proximityFunction) {
        gpii.windows.userListeners.proximityFunction = edge.func({
            ...
            references: [
                path.join(process.env.SystemRoot, "Sysnative\\WinMetadata\\Windows.Networking.winmd"),
                path.join(process.env.SystemRoot, "Sysnative\\WinMetadata\\Windows.Storage.winmd"),
                "System.Runtime.dll",
