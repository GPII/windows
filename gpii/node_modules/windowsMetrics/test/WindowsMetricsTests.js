...
gpii.tests.metrics.getRawInputData = function (hRawInput, uiCommand, pData, pcbSize, cbSizeHeader) {
    var invalidParams =
        uiCommand !== gpii.windows.flagConstants.RID_INPUT ||
...
gpii.tests.metrics.convertLParam = function (input) {
    ...
    if (mouseInput) {
        ...
        rawMouse.header.dwType = gpii.windows.flagConstants.RIM_TYPEMOUSE;
        ...
        rawKeyboard.header.dwType = gpii.windows.flagConstants.RIM_TYPEKEYBOARD;
