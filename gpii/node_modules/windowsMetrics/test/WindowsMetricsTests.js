...
fluid.defaults("gpii.tests.metrics.windowsMetricsWrapper", {
    ...
    listeners: {
        ...
        "onStartMetrics.keyboard": null,
        "onStopMetrics.application": null,
        "onStopMetrics.keyboard": null
    }
});
...
jqUnit.asyncTest("Testing application metrics", function () {
    ...
    // Get rid of the "Your Windows licence will expire soon" message - it prevents our test windows getting focus.
    gpii.windowsMetrics.killProcessByName("LicensingUI.exe");
