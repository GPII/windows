...
gpii.windows.spi.getCurrentSettings = function (payload) {
    var getAction = gpii.windows.spi.parameters[payload.options.getAction];
...
gpii.windows.spi.waitForSpi = function (action) {
    if (action === gpii.windows.spi.parameters.SPI_SETHIGHCONTRAST) {
        /*
...
gpii.windows.spi.applySettings = function (payload) {
    var action = gpii.windows.spi.parameters[payload.options.setAction];
    var uiParam = gpii.windows.spi.getUiParam(payload);
    ...
    var problematicSpiCalls = [
        gpii.windows.spi.parameters.SPI_SETNONCLIENTMETRICS
    ];
...
/**
 * All known uiParam values of SystemParametersInfo.
 * Taken from WinUser.h
 */
gpii.windows.spi.parameters = {
    "SPI_GETBEEP": 0x0001,
    "SPI_SETBEEP": 0x0002,
    "SPI_GETMOUSE": 0x0003,
    "SPI_SETMOUSE": 0x0004,
...
gpii.windows.spi.parametersLookup = {};
fluid.each(gpii.windows.spi.parameters, function (value, key) {
    gpii.windows.spi.parametersLookup[value] = key;
});
