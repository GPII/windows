...
jqUnit.test("Testing registrySettingsHandler API (get and set functions)", function () {
    ...
    var result2 = windows.registrySettingsHandler.set(apiTest.set.payload);
    // check results
    jqUnit.assertDeepEq("Checking return payload of set", result2, apiTest.set.expectedResult);
    // cleanup
    windows.deleteRegistryKey("HKEY_CURRENT_USER", "Software\\GPIIMagnifier");
});
