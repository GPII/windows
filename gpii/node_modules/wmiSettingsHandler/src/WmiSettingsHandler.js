...
gpii.windows.wmi.setImpl = function (payload) {
    ...
    fluid.each(getResults, function (result, settingId) {
        if (result.value === null) {
            ...
            fluid.set(results, settingId + ".oldValue", null);
            fluid.set(results, settingId + ".newValue", null);
        }
    });

    fluid.each(fPayload, function (setting, settingId) {
        if (fluid.get(results, settingId + ".oldValue") !== null) {
            fluid.set(results, settingId + ".oldValue", getResults[settingId].value);
            ...
            fluid.set(results, settingId + ".newValue", getResults[settingId].value);
        }
    });
...
gpii.windows.wmi.getImpl = function (payload) {
    ...
    fluid.each(settingsOptions, function (settingOptions, settingId) {
        ...
        fluid.set(results, settingId + ".value", windows.wmi.getQuery(query));
    });
