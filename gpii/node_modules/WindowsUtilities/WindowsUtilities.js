 ...
 * @param {*} options.conditionValue The value that the function will return to indicate the condition is met.
 *  This is compared using '===', but the default is anything that resolves to true.
 ...
 * @param {number} options.pollDelay The delay (ms) between each poll.
