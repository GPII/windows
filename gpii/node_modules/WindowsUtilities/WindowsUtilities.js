...
windows.DEVMODEW = new Struct([
	...
	["short", "dmPrintQuality"], // TODO check padding here
	//	};
	//	struct {
	//		POINTL dmPosition;
...
windows.getScreenResolution = function (filename) {
    var dm = new windows.DEVMODEW();
    dm.ref().fill(0);
    dm.dmSize = windows.DEVMODEW.size;

	if (0 != windows.user32.EnumDisplaySettingsW(ref.NULL, c.ENUM_CURRENT_SETTINGS, dm.ref()))
	{
