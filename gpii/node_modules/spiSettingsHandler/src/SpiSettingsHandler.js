...
windows.setFlagValues = function (action, uiParam, structName, flagNames) {
	...
	if (pvParam.lpszDefaultScheme !== undefined) {
		pvParam.lpszDefaultScheme = util.windows.stringToWideChar('High Contrast White'); //FIXME This should be passed as a parameter!
	}
...
windows.getUiParam = function (payload) {
	...
	if (payload.options.uiParam === 'struct_size') {
		return windows.structures[payload.options.pvParamName].size;
	}
