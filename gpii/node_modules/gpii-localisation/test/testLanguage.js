...
gpii.tests.windows.language.codeCaseTests = fluid.freezeRecursive({
    ...
    tests: {
        // Simple language subtag, without region (expanded using fullCode):
        "bg-BG": ["bg", "BG"],
        "ko-KR": ["ko", "KO"],
        "te-IN": ["te", "TE"],
        "pl-PL": ["pl", "pl"],
        ...
        "quc-Latn-GT": ["quc-Latn-gt", "QUC-Latn-GT", "qut-gt", "QUT-GT"],
...
jqUnit.test("Test language code casing", function () {
    var tests = gpii.tests.windows.language.codeCaseTests.tests;
    var fullCodes = gpii.tests.windows.language.codeCaseTests.fullCodes;
    fluid.each(tests, function (inputs, langCode) {
        ...
        fluid.each(inputs, function (input) {
            ...
            var result = gpii.windows.language.fixLangCode(input, fullCodes);
