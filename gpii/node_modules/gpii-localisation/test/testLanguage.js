...
// We determine whether this is a postLTSC version of Windows 10.
// Windows 10 LTSC Version 1809 (OS build 17763), see:
// https://docs.microsoft.com/en-us/windows/release-information/
var postLTSC = semver.gt(os.release(), "10.0.17763")? true: false;
    ...
    // Perform the tests in a single chunk, to save starting so many processes.
    {
        ...
        expect: {
            ...
            "bg-GB": {
                ...
                "native": (postLTSC? "български (bg-GB)": ""),
                "code": "bg-GB"
            },
            "ta-LK": {
            ...
            "en-xyz": {
                ...
                "native": (postLTSC? "English (en-xyz)": ""),
                "code": "en-xyz"
            }
        }
    },
